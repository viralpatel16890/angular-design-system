...
const primitives = {
  ...
  'red-500': '#f43f5e', 'red-600': '#e11d48', 'red-700': '#be123c',
...
const semanticLight = {
  ...
  'color-danger-default': p('red-600'),
...
const pairs = [
  ...
  { name: 'badge--info text/bg', usedBy: 'badge (info variant) — no dark-mode override', kind: 'normal',
    light: [semanticLight['color-text-info'], semanticLight['color-info-muted']],
    dark:  [semanticLight['color-text-info'], semanticLight['color-info-muted']] },
  ...
  { name: 'alert (info/default) fg/bg', usedBy: 'alert default variant — not theme-adjusted', kind: 'normal',
    light: [semanticLight['color-text-info'], semanticLight['color-info-subtle']],
    dark:  [semanticLight['color-text-info'], semanticLight['color-info-subtle']] },
